...
app.config['SESSION_REDIS'] = redis.Redis(host='127.0.0.1', port=6379, password='waddup')
sess = Session()
sess.init_app(app)

# Setup SocketIO
socketio = SocketIO(app)
socketio.init_app(app, async_mode=async_mode, message_queue='redis://:waddup@127.0.0.1:6379/')
